...
export default function AdvancedSidebar() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex">
      {/* Header for demo */}
      <header className="fixed top-0 left-0 right-0 h-16 bg-gray-900/80 backdrop-blur-md text-white flex items-center justify-between z-50 px-6 shadow-lg border-b border-gray-800">
        <div className="flex items-center gap-4">
          <button
            className="md:hidden text-2xl hover:bg-gray-800 p-2 rounded-lg transition-colors"
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-extrabold tracking-tight">Paikaree</span>
          </div>
        </div>
        <div className="flex items-center gap-4">
      ...
      {/* Main Content */}
      <main className={`flex-1 transition-all duration-300 ${open ? 'md:ml-72' : ''} mt-16 p-8`}>
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold text-white mb-4">Dashboard</h1>
          <p className="text-gray-400">Your advanced sidebar is ready! Toggle it with the menu button on mobile.</p>
        </div>
      </main>
